...
with open(Valid_File_w_etc, 'w') as file:
    for fileNum in range(ValidData_start,ValidData_End):
        for jpgNum in range(facedata_start, facedata_end): 
            ...
            file.write("Training/" + str(fileNum) + "/KINECT/Light_03_Low/attack_02_print_none_curved/color/crop/" + convert(jpgNum) + ".jpg Training/" + str(fileNum) + "/KINECT/Light_03_Low/attack_02_print_none_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
            ...
            file.write("Training/" + str(fileNum) + "/KINECT/Light_03_Low/attack_03_print_eye_nose_mouth_flat/color/crop/" + convert(jpgNum) + ".jpg Training/" + str(fileNum) + "/KINECT/Light_03_Low/attack_03_print_eye_nose_mouth_flat/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
            ...
            file.write("Training/" + str(fileNum) + "/KINECT/Light_03_Low/attack_04_print_eye_nose_mouth_curved/color/crop/" + convert(jpgNum) + ".jpg Training/" + str(fileNum) + "/KINECT/Light_03_Low/attack_04_print_eye_nose_mouth_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
...
with open(Test_File, 'w') as file:
    for fileNum in range(TestData_Start,TestData_End):
        for jpgNum in range(facedata_start, facedata_end): 
            file.write("Test/" + str(fileNum) + "/KINECT/Light_01_High/real_01/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_01_High/real_01/depth/crop/" + convert(jpgNum) + ".jpg 1\n" )
            file.write("Test/" + str(fileNum) + "/KINECT/Light_02_Mid/real_01/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_02_Mid/real_01/depth/crop/" + convert(jpgNum) + ".jpg 1\n" )
            file.write("Test/" + str(fileNum) + "/KINECT/Light_03_Low/real_01/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_03_Low/real_01/depth/crop/" + convert(jpgNum) + ".jpg 1\n" )

            file.write("Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_07_3d_mask/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_07_3d_mask/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )        
            file.write("Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_07_3d_mask/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_07_3d_mask/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
            file.write("Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_07_3d_mask/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_07_3d_mask/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
...
with open(Test_File_w_etc, 'w') as file:
    for fileNum in range(TestData_Start,TestData_End):
        for jpgNum in range(facedata_start, facedata_end):
            ...
            file.write("Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_01_print_none_flat/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_01_print_none_flat/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )        
            file.write("Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_01_print_none_flat/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_01_print_none_flat/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
            file.write("Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_01_print_none_flat/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_01_print_none_flat/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )

            file.write("Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_02_print_none_curved/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_02_print_none_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )        
            file.write("Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_02_print_none_curved/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_02_print_none_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
            file.write("Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_02_print_none_curved/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_02_print_none_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )

            file.write("Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_03_print_eye_nose_mouth_flat/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_03_print_eye_nose_mouth_flat/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )        
            file.write("Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_03_print_eye_nose_mouth_flat/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_03_print_eye_nose_mouth_flat/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
            file.write("Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_03_print_eye_nose_mouth_flat/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_03_print_eye_nose_mouth_flat/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )

            file.write("Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_04_print_eye_nose_mouth_curved/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_01_High/attack_04_print_eye_nose_mouth_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )        
            file.write("Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_04_print_eye_nose_mouth_curved/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_02_Mid/attack_04_print_eye_nose_mouth_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
            file.write("Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_04_print_eye_nose_mouth_curved/color/crop/" + convert(jpgNum) + ".jpg Test/" + str(fileNum) + "/KINECT/Light_03_Low/attack_04_print_eye_nose_mouth_curved/depth/crop/" + convert(jpgNum) + ".jpg 0\n" )
