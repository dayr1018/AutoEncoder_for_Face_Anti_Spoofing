...
class Auto_Encoder_Dropout_v1(nn.Module):
    def __init__(self):
        super(Auto_Encoder_Dropout_v1, self).__init__()
...
class Auto_Encoder_Dropout_v2(nn.Module):
    def __init__(self):
        super(Auto_Encoder_Dropout_v2, self).__init__()
